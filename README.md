...
|---|---|---|---|---|
| 2026-08-20（四）早上 | 產出金融科技創新園區 2026 FinTech 國際校園大使實習機構推薦函。 | 支援 FinTech 國際校園大使申請。 | 完成可送出的實習機構推薦函文字 / 檔案，內容能對應國泰實習、雲端應用開發科、AI / AWS PoC 與溝通協作表現。 | 已逾期；待補完成證據 |
| 2026-08-21（五）結束前 | 投遞 AWS 校園大使。 | 完成 AWS 校園大使申請。 | 先完成履歷修改，再整理作品集，最後完成投遞；履歷需凸顯國泰雲端部門、AWS PoC 雷達、AI PM、雲端 / AI / 技術推廣經驗。 | 未開始 |
| 2026-08-20（四） | 參加人壽 2nd 共融活動（總公司）。 | 累積公司情境與團隊合作證據。 | 活動後補進當日 inbox / 日誌，保留可用於 final proposal 的成長素材。 | 日期已過；待補實際參與或缺席紀錄 |
