...
| 職安科 Webex 直播 | 2026-08-26（三）09:30-10:30 | Cleo 回報已完成觀看。 | 準時進入 Webex 觀看職安科直播；觀看後若有實習相關重點再補進當日紀錄。 |
| Mentor 離職事項盤點 | 2026-08-28（五）上午 | 已排入待辦。 | 再次和 mentor 盤點離職 / 交接事項，確認需要繳交、歸還、結清或補完成的項目，盤點後補進當日 inbox / 日誌。 |
...
|---|---|---|---|---|
| 2026-08-21（五）已過 | 金融科技創新園區 2026 FinTech 國際校園大使實習機構推薦函用印審查。 | 支援 FinTech 國際校園大使申請。 | 推薦函已提交公司用印送審；待審查完成後由公司蓋章。 | 已送審；待公司蓋章 |
| 2026-08-26（三）09:30-10:30 | 到 Webex 觀看職安科直播。 | 不漏掉公司安全衛生訓練行程。 | 準時進入 Webex 直播；若有實習相關重點，活動後補進當日 inbox / 日誌。 | 已完成（Cleo 回報） |
| 2026-08-28（五）上午 | 再次和 mentor 盤點離職 / 交接事項。 | 實習離職收尾與交接完整性。 | 確認需繳交、歸還、結清或補完成的事項；盤點後更新待辦狀態並補進當日 inbox / 日誌。 | 未開始 |
| 2026-08-28（五）13:30 | 海大教授到公司訪視評分。 | 學校端正式訪視與評分。 | 直接拿 8/14 部會成果簡報／剪報給教授看；訪視後補進當日 inbox / 日誌。 | 未開始 |
| 2026-08-31（一）前 | 看完 Udemy AWS SAA 2025 Part 1。 | 補強 AWS 架構師基礎。 | 完成 Part 1 約 100 部 3-5 分鐘短片；目前進度第 12 部，仍在 IAM 單元。 | 進行中 |
| 2026-08-31（一） | 參加集團結訓典禮（國泰金融會議中心）。 | 實習收尾與成果回顧。 | 活動後補進日誌，整理可放進 final proposal / 結案回顧的素材。 | 未開始 |
| 2026-09-08（二）19:00-20:55 | 線上參加 AWS Educate 9th 雲端校園大使招募說明會。 | 先理解 AWS 校園大使職缺與申請要求。 | 參加線上說明會，整理投遞需要補強的履歷、作品集或申請重點。 | 未開始 |
| 2026-09-09（三） | 投遞 AWS 校園大使職缺。 | 完成 AWS 校園大使申請。 | 依說明會資訊確認履歷與作品集後送出申請；履歷需凸顯國泰雲端部門、AWS PoC 雷達、AI PM、雲端 / AI / 技術推廣經驗。 | 未開始 |
