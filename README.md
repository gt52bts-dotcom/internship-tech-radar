...
| 日期 | 今日主軸 |
|---|---|
| [8/25](./logs/daily/work-log-2026-08-25.md) | 依主辦單位回饋完成兩張可編輯 AI 提案補強頁，聚焦 Prompt 設計、可控 token 成本與可執行提醒規則；整份提案尚待整合。 |
...
| 2026-08-21（五）已過 | 投遞 AWS 校園大使。 | 完成 AWS 校園大使申請。 | 先完成履歷修改，再整理作品集，最後完成投遞；履歷需凸顯國泰雲端部門、AWS PoC 雷達、AI PM、雲端 / AI / 技術推廣經驗。 | 尚無完成證據；待確認是否已投遞 |
