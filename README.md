...
| 交付物 | 日期 / 時點 | 目前狀態 | 完成條件 |
|---|---|---|---|
| AI PM 使用分享 | 2026-08-19（三）下午 | 簡報已於 8/18 完成；分享是否完成與現場回饋待補當日證據。 | Cleo 與 mentor 一起主持；Cleo 有 15 分鐘分享 AI PM 的實際使用方式，包含白話指令、AI 轉成可執行任務、Cleo 修正判斷、規則寫入記憶、最後形成日誌／文件／驗證證據的前後差異。 |
...
|---|---|---|---|---|
| 2026-08-19（三）下午 | AI PM 使用分享。 | Cleo 與 mentor 一起主持；Cleo 分享 AI PM 的實際使用方式。 | 15 分鐘內完成可展示的前後差異、限制與下一步，不直接沿用舊版草稿。 | 簡報已完成；待補今日分享是否完成與回饋 |
| 2026-08-20（四）早上 | 產出金融科技創新園區 2026 FinTech 國際校園大使實習機構推薦函。 | 支援 FinTech 國際校園大使申請。 | 完成可送出的實習機構推薦函文字 / 檔案，內容能對應國泰實習、雲端應用開發科、AI / AWS PoC 與溝通協作表現。 | 未開始 |
