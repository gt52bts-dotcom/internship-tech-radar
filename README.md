...
截至 2026-08-11，改採硬審核口徑後累積分數 153 分。每日五個 Skill 加總最高 10 分；2026-08-10 補入 Quick Suite 停止案例、四案例時間統計與 8/14 報告素材，2026-08-11 無新增可計分技術成果。

| Skill | 說明 | 累積分數 |
|---|---|---:|
| Skill 1｜掃描 | 資料來源掃描、候選技術收集、帳號資源盤點 | 24 |
| Skill 2｜比較 | 候選技術比較、部署方式與限制對照 | 22 |
| Skill 3｜評估 | 評分邏輯、風險、成本與可行性判斷 | 33 |
| Skill 4｜驗證 | 部署驗證、權限驗證、錯誤排查 | 44 |
| Skill 5｜報告 | 報告、教學書、dashboard、週誌 | 30 |
