...
Set-Content -LiteralPath $EncryptionPath -Value $EncryptionJson -Encoding UTF8
...
aws s3 cp $HelloPath "s3://$Bucket/$Prefix"
...
Set-Content -LiteralPath $TrustPath -Value $TrustPolicy -Encoding UTF8
...
Set-Content -LiteralPath $Ec2BucketReadPath -Value $Ec2BucketReadPolicy -Encoding UTF8
