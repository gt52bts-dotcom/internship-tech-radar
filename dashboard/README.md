...
| 入口 | 用途 |
|---|---|
| [查看評分表集合](../evaluation-forms/README.md) | 可選不同評分表：國泰實習生評鑑表單、國泰 Mentor 觀察表、未來學校表單。 |
| [查看主管評分摘要（Notion）](https://app.notion.com/p/3a49d9fba316816c8f95d2a2ff997350) | 給主管快速看目前四大項目自評、Mentor 15 項待補狀態與每日更新規則。 |
...
目前主管評分自評摘要：四大項目平均 `4.5 / 5`；Mentor 15 項行為觀察暫不評分、不計平均。正式成績仍以主管評分為準。
