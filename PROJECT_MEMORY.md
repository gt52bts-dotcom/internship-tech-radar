...
- 正式每日實習日誌是由 Codex 代 Cleo 書寫，語氣要像 Cleo 本人的實習紀錄：少廢話、直接、自然、具體。可以用「我」，但不要每句都硬塞主詞；以成果、證據、問題、下一步為主，不寫過多感想或鋪陳。不要寫成第三人稱專案紀錄，也不要把 Codex 操作寫成敘事主體。若需要提到 AI，應寫成「我使用 AI PM 協助整理／驗證／追蹤」。
