...
- 剩餘工作日策略於 2026-07-24 再校正：時間其實來得及，但要用「一天驗證兩個階段」的短衝刺節奏。2026-07-24 完成 S0；2026-07-27 先完成 2026-07-28 科會 AI PM 簡報、10 分鐘講稿與 2-3 組證據，再接 S1/S2；2026-07-28 下午完成 S3/S4；2026-07-29 完成 S5 並用多篇報導驗證。之後再把驗證結果轉成論文式 final proposal、展示圖表與口說稿。若新需求無法支援「最終成果發表、論文式敘事、可驗證證據」三件事，預設延後或移出主線。
