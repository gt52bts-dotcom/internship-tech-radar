...
- 2026-08-26 Cleo 更新 AWS 校園大使申請節奏：2026-09-08（二）19:00-20:55 線上參加 `AWS Educate 9th 雲端校園大使招募說明會`，2026-09-09（三）再投遞 AWS 校園大使職缺。舊的 2026-08-21 投遞期限不再作 active deadline；投遞前仍需確認履歷與作品集主軸凸顯國泰人壽雲端技術發展部雲端應用開發科、AI 驅動的 AWS PoC 雷達、AI PM、雲端 / AI / 技術推廣經驗。
- 2026-08-24 Cleo 新增實習收尾待辦：2026-08-28（五）上午要再次和 mentor 盤點離職 / 交接事項；完成條件是確認需繳交、歸還、結清或補完成的項目，盤點後更新 README 待辦狀態並補進當日 inbox / 正式日誌。
- 2026-08-21 FinTech 國際校園大使推薦信狀態：已提交公司用印送審，審查完成後預計下週才會蓋章；在蓋章前不可寫成已完成用印或正式取得推薦函。
...
- 2026-07-28 使用者新增學校端正式訪視時程：2026-08-28（五）13:30 海大教授到公司訪視評分。使用者修正：訪視時不另外準備專案簡報重點或成果證據包，直接拿 2026-08-14 部會成果簡報／剪報給教授看。
